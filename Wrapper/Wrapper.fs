...
//        let configuration =
//            MenuConfiguration(fun x ->
//                x?item?ValueTag
//                |> Option.iter f
//            )
//        Menu(el.Dom, configuration) |> ignore
//        el
//
//module DropDown =
...
//        match current with
//        | None ->
//            DropDownConfiguration("text", "value", values)
//        | Some v ->
//            let i = List.findIndex (fun (_, x) -> x = v) choices
//            DropDownConfiguration("text", "value", values, Index = i)
//
...
//                Editable = false,//EditableConfiguration false,
